...
| Platform | Archive |
| --- | --- |
| Linux, x86-64 | `gdmerge-v0.3.6-x86_64-unknown-linux-gnu.tar.gz` |
| macOS, Apple silicon | `gdmerge-v0.3.6-aarch64-apple-darwin.tar.gz` |
| macOS, Intel | `gdmerge-v0.3.6-x86_64-apple-darwin.tar.gz` |
| Windows, x86-64 | `gdmerge-v0.3.6-x86_64-pc-windows-msvc.zip` |

```console
$ sha256sum -c gdmerge-v0.3.6-x86_64-unknown-linux-gnu.tar.gz.sha256
gdmerge-v0.3.6-x86_64-unknown-linux-gnu.tar.gz: OK
$ tar xzf gdmerge-v0.3.6-x86_64-unknown-linux-gnu.tar.gz
